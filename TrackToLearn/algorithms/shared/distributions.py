...
class VonMisesFisher(torch.distributions.Distribution):
    ...
    def mean(self):
        ...
        # )
        # option 2:
        return self.loc * ive(torch.tensor(self.__m / 2), self.scale)
        # options 3:
    ...
    def entropy(self):
        ...
        # )
        # option 2:
        output = - self.scale * ive(torch.tensor(self.__m / 2), self.scale)
        # option 3:
    ...
    def _log_normalization(self):
        output = -(
            ...
            - (self.scale + torch.log(ive(torch.tensor(self.__m / 2 - 1), self.scale)))
        )

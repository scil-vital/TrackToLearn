...
class TrackToLearnValidation(TrackToLearnExperiment):
    ...
    def __init__(
        ...
        self.valid_noise = valid_dto['valid_noise']
        self.policy = valid_dto['policy']
        self.n_actor = valid_dto['n_actor']
        self.n_seeds_per_voxel = valid_dto['n_seeds_per_voxel']
        ...
        with open(valid_dto['hyperparameters'], 'r') as json_file:
            ...
            if not valid_dto['valid_max_angle']:
                self.max_angle = hyperparams['max_angle']
            else:
                self.max_angle = valid_dto['valid_max_angle']
...
def add_valid_args(parser):
    ...
    parser.add_argument('--fa_map', type=str, default=None,
                        ...
                        'tracking')
    parser.add_argument('--valid_max_angle', type=float, default=None,

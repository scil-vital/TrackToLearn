...
seeding_file=$DATASET_FOLDER/datasets/${SUBJECT_ID}/maps/hcp_100206_interface.nii.gz
tracking_file=$DATASET_FOLDER/datasets/${SUBJECT_ID}/masks/hcp_100206_wm.nii.gz
